...
namespace AnalaizerUnitTests
{
    ...
    public class AnalaizerClassTests
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"C:\Users\Lenovo\Desktop\Lab_1\Calculator\AnalaizerUnitTests\testData.xml", "Test", DataAccessMethod.Sequential)]

        [TestMethod()]
        public void IsDelimeterTests()
        {
            ///Arrange
